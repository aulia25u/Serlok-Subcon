...
@section('title', 'Upload LOI External')
@section('page-title', 'Upload LOI External')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Upload LOI External</h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Add New LOI External</h5>
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewModalLabel">View LOI External</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.add-drawing-btn', function() {
            ...
            $('#addModalLabel').text('Add New LOI External');
            $('#partId').val(partId);
            $('#addModal').modal('show');
        });
        ...
        $('#attachmentForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('upload.loi-external.store') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    $('#successDescription').text('LOI External telah berhasil disimpan ke dalam sistem.');
        ...
        $(document).on('click', '.view-btn', function() {
            let partId = $(this).data('id');
            let viewUrl = "{{ url('upload/loi-external') }}/" + partId;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.length > 0) {
                        ...
                        drawingListHtml = '<div class="col-12"><p class="text-center">No LOI External found for this part.</p></div>';
                    }
        ...
        $(document).on('click', '.delete-drawing-btn', function() {
            ...
            let deleteUrl = `/upload/loi-external/${drawingId}`;
            let button = $(this);

            if (confirm('Are you sure you want to delete this LOI External?')) {
                $.ajax({
                    url: deleteUrl,
                    type: 'DELETE',
                    success: function(response) {
                        ...
                        if ($('#drawingList .col-md-4').length === 0) {
                            $('#drawingList').html('<div class="col-12"><p class="text-center">No LOI External found for this part.</p></div>');
                        }
                    },
                    error: function(xhr) {
