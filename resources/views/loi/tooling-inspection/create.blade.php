...
@section('title', 'Create Tooling Inspection')
        ...
        <form id="toolingInspectionForm" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Max size: 5MB. Formats: JPEG, PNG, JPG, GIF</small>
                </div>
                    ...
                    <table class="table table-bordered table-sm inspection-table" id="inspectionTable">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center" rowspan="2" style="width: 80px; vertical-align: middle;">X̄</th>
                                <th class="text-center" rowspan="2" style="width: 80px; vertical-align: middle;">R</th>
                                <th class="text-center" rowspan="2" style="width: 70px; vertical-align: middle;">Action
                                </th>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-6">
                        <div class="decision-switch-container">
                            ...
                            <div class="decision-switch">
                                <button type="button" class="btn decision-btn" id="btnResultOK">OK</button>
                                <button type="button" class="btn decision-btn" id="btnResultNG">NG</button>
                            </div>
            ...
            <div class="card-footer d-flex justify-content-center">
                <button type="submit" class="btn btn-primary mr-2" id="submitBtn">
                    <i class="fas fa-save"></i> Save Tooling Inspection
                </button>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadPartNumbers(customerId) {
            ...
            $('#image').change(function(e) {
                ...
                if (file) {
                    ...
                    if (file.size > maxSize) {
                        ...
                        $(this).val('');
                        $('#imagePreviewBox').html('<span class="text-muted">No image selected</span>');
                        return;
                    }
            ...
            function addInspectionRow() {
                ...
                const newRow = `
                    <tr data-row="${rowCount}">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm inspection-method-input" name="items[${rowCount}][inspection_method]" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm inspection-standard-input" name="items[${rowCount}][standard]" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_1]" placeholder="1">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_2]" placeholder="2">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_3]" placeholder="3">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_4]" placeholder="4">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_5]" placeholder="5">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_6]" placeholder="6">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_7]" placeholder="7">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_8]" placeholder="8">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_9]" placeholder="9">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][tooling_10]" placeholder="10">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][x_bar]" placeholder="X̄">
                        </td>
                        <td>
                            <input type="text" class="form-control form-control-sm" name="items[${rowCount}][r_value]" placeholder="R">
                        </td>
            ...
            $('#toolingInspectionForm').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('loi.tooling-inspection.store') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    error: function(xhr) {
                        ...
                        let errorMessage =
                            'An error occurred while creating the tooling inspection.';
